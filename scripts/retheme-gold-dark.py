...
for path in files:
    ...
    button_pairs = [
        ...
        (
            "bg-[#1a1612] px-2.5 py-1 text-[#f4f0e8]",
            "bg-[#c9a66b] px-2.5 py-1 text-[#0a0b0d]",
        ),
        (
            "bg-[#1a1612] px-3 py-1 text-[#f4f0e8]",
            "bg-[#c9a66b] px-3 py-1 text-[#0a0b0d]",
        ),
        (
